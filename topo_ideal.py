...
"""
- Essa é a topologia ideal, mas não está funcionando totalmente.
- Mesmo adicionando uma rota para o NFV o roteador continua encaminhando direto para o host.
- Para fazer funcionar eu teria que implementar um roteador ryu para tentar inserir uma rota
mais especifica pra ver se funcionaria.
"""
def myNetwork():
    ...
    c0.cmd('ryu-manager rest_router.py &')
