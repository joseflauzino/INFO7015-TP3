...
// Device declaration
from_eth1 :: FromDevice(h4-eth0, SNIFFER false);
to_eth1 :: Queue -> ToDevice(h4-eth0);

from_eth2 :: FromDevice(h4-eth1, SNIFFER false);
to_eth2 :: Queue -> ToDevice(h4-eth1);
...
ether_encap2 :: EtherEncap(0x0800, 52:4b:fc:c8:12:db, 00:00:00:00:00:01);//e2:7e:80:21:f1:ce);
